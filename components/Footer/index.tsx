    ...
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection lg:px-30 sm:mx-30 md:mx-40">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
                  ...
                  <form action="#">
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-1 p-4"
                      >
                        <svg
          ...
          {/* <!-- Footer Bottom --> */}
          <div className="flex flex-col items-center justify-between gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
            ...
            >
              <p className="text-center lg:text-left">
                Copyright &copy; {new Date().getFullYear()} InventX. All Rights Reserved
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="animate_top"
            >
              <ul className="flex items-center gap-8 text-center lg:text-right">
                <li>
