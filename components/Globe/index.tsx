...
export function Globe() {
  ...
  const colors = ["#32CD32", "#228B22", "#228B22"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <div className="flex flex-row items-center justify-center relative w-full bg-transparent h-auto">
      <div>
        <div>
        ...
        <div className="mx-auto relative overflow-hidden h-[25rem] md:h-[40rem] px-4 bg-transparent flex justify-center items-center">
          <motion.div
            initial={{
              opacity: 0,
              y: 20,
